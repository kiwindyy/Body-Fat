...
The remainder of this paper is structured as follows: @sec-data explains the dataset source, how it was collected, and describes the variables used. @sec-model outlines the multi-linear regression setup and the rationale for its use. @sec-results presents the regression outcomes, showing how the predictors explain body fat percentage. @sec-discussion interprets the findings, notes limitations, and suggests improvements. @sec-a is the raw dataset before any cleaning. @sec-b explores survey, sampling, and observational data methods, including measurement techniques, simulations.
...
- Height: The standing height of the individual, often used alongside weight to calculate proportions and indices.
...
# Raw Data of Body Fat Percentage {#sec-a}
...
# Surveys, sampling, and observational data {#sec-b}
